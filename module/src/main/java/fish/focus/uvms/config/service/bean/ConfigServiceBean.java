 ...
 */
package fish.focus.uvms.config.service.bean;

import fish.focus.schema.config.types.v1.SettingType;
import fish.focus.schema.config.types.v1.SettingsCatalogEntry;
import fish.focus.uvms.audit.model.mapper.AuditLogModelMapper;
import fish.focus.uvms.config.model.constants.AuditObjectTypeEnum;
import fish.focus.uvms.config.model.constants.AuditOperationEnum;
import fish.focus.uvms.config.model.mapper.ModuleRequestMapper;
import fish.focus.uvms.config.service.message.ConfigMessageProducerBean;
