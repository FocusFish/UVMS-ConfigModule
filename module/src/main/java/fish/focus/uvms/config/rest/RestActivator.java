...
import fish.focus.uvms.config.rest.constants.RestConstants;
import fish.focus.uvms.config.rest.filter.ConfigRestExceptionMapper;
import fish.focus.uvms.config.rest.service.SettingsRestResource;
...
public class RestActivator extends Application {
    ...
    public RestActivator() {
        set.add(SettingsRestResource.class);
        set.add(UnionVMSFeatureFilter.class);
        set.add(JsonBConfigurator.class);
        set.add(ConfigRestExceptionMapper.class);
